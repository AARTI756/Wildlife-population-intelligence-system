...
def main():
    ...
    print("--------------------------------------------------")
    print("LOG: Initiating Health scoring API Audits.")
    print("--------------------------------------------------")
    ...
    if all_ok:
        print("LOG: All Health scoring API validation audits PASSED successfully.")
    else:
        print("ERROR: Some Health scoring API validation audits failed.")
        sys.exit(1)
