...
def main():
    dummy_user = User(id=1, username="test_officer")
    ...
    print("--------------------------------------------------")
    print("LOG: Initiating Habitat Intelligence API Audits...")
    print("--------------------------------------------------")
    ...
    if all_ok:
        print("LOG: All Habitat API validation audits PASSED successfully.")
    else:
        print("ERROR: Some Habitat API validation audits failed.")
        sys.exit(1)
