...
def main():
    ...
    print("--------------------------------------------------")
    print("LOG: Initiating Executive Intelligence API Audits.")
    print("--------------------------------------------------")
    ...
    if all_ok:
        print("LOG: All Executive Intelligence API validation audits PASSED successfully.")
    else:
        print("ERROR: Some Executive Intelligence API validation audits failed.")
        sys.exit(1)
