...
def main():
    dummy_user = User(id=1, username="test_analyst")
    ...
    print("--------------------------------------------------")
    print("LOG: Initiating Biodiversity Analytics API Audits.")
    print("--------------------------------------------------")
    ...
    if all_ok:
        print("LOG: All Biodiversity API validation audits PASSED successfully.")
    else:
        print("ERROR: Some Biodiversity API validation audits failed.")
        sys.exit(1)
